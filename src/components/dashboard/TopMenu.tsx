...
import { CiBellOn, CiChat1, CiMenuBurger, CiSearch, CiShoppingBasket, CiShoppingCart } from 'react-icons/ci';
    ...
    <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
      <div className="px-6 flex items-center justify-between space-x-4">
        ...
        <div className="flex space-x-2">
          ...
          >
            {/* <span className='text-sm mr-2'>10</span> */}
            {
              totalCount > 0 && (
                <span className="absolute -top-2 left-5 rounded-full bg-red-500 py-0.5 px-[7px] text-xs text-red-50">{totalCount}</span>
              )
            }
